...
void Generator::insert_data(Transcript*& current) {
   ...
   *    4.1. According to year, generating that 4*year numbers of semester with period and save them into BST<Semester*> semesters
   *    4.2. ask user whether he has registered course in that semester
   *      4.2.1. yes then
